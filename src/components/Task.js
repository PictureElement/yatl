  ...
  return (
    <li className="todo-item">
      ...
      <div className="todo-item__group-right">
        <button onClick={() => props.deleteTask(props.task.id)} className="todo-item__button todo-item__button_delete" type="button">
        ...
        <button onClick={props.onClick} className="todo-item__button todo-item__button_edit" type="button">
          ...
          <span class="visually-hidden">Edit task</span>
        </button>
      </div>
    </li>
  )
