...
function Task(props) {
  ...
  // 'isEditing' state to check if in editing mode
  ...
  return (
    ...
    //     </button>
    //     <button onClick={props.onClick} className="todo-item__button todo-item__button_primary" type="button">
    ...
    <li className="todo-item">
      ...
      <div className="todo-item__group-right">
        <button onClick={() => props.deleteTask(props.task.id)} className="todo-item__button todo-item__button_primary mr-2" type="button">
        ...
        <button onClick={props.onClick} className="todo-item__button todo-item__button_success" type="button">
