    ...
    <li className="todo-item">
      ...
      <div className="todo-item__group-right">
        <div className="tooltip mr-2">
          ...
          <div className="tooltip__arrow" />
          <button onClick={() => props.deleteTask(props.task.id)} className="todo-item__button todo-item__button_danger" type="button">
      ...
      <form className="d-flex justify-content-between align-items-center w-100" onSubmit={handleSubmit}>
        ...
        <div className="todo-item__group-right">
          <div className="tooltip mr-2">
            ...
            <div className="tooltip__arrow" />
            <button onClick={() => setEditing(false)} className="todo-item__button todo-item__button_primary" type="button">
